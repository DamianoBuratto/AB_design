...
from rfantibody.rfdiffusion.util_module import init_lecun_normal_param

class SE3TransformerWrapper(torch.nn.Module):
    ...
    def reset_parameter(self):
        ...
        torch.nn.init.zeros_(self.se3.graph_modules[-1].to_kernel_self['0'])
        torch.nn.init.zeros_(self.se3.graph_modules[-1].to_kernel_self['1'])
